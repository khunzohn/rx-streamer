...
public abstract class UserModel {
  ...
  public static UserModel create(String gistsUrl, String reposUrl, String followingUrl,
      ...
      String htmlUrl, boolean siteAdmin, int id, String gravatarId, String organizationsUrl) {
    return builder()
        .gistsUrl(gistsUrl)
        .reposUrl(reposUrl)
